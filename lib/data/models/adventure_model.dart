...
class TurnLog {
  final int turn;
  final String actor; // PLAYER / MONSTER
  final int damage;
...
class BattleStartResult {
  ...
  BattleStartResult({
    ...
    required this.monsterDef,
    this.monsterImageKey,
    required this.playerMaxHp,
    required this.playerAtk,
    required this.playerDef,
    required this.logs,
  });
  ...
  factory BattleStartResult.fromJson(Map<String, dynamic> json) =>
      BattleStartResult(
        ...
        monsterAtk: json['monsterAtk'],
        monsterDef: json['monsterDef'],
        monsterImageKey: json['monsterImageKey'],
        playerMaxHp: json['playerMaxHp'],
        playerAtk: json['playerAtk'],
        playerDef: json['playerDef'],
        logs: (json['logs'] as List)
            .map((e) => TurnLog.fromJson(e))
            .toList(),
      );
}
...
class BattleConfirmResult {
  ...
  BattleConfirmResult({
    ...
    required this.newAtk,
    required this.newDef,
...
class CharacterStatModel {
  ...
  double get expProgress => exp / requiredExp;
