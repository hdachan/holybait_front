      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Icon(Icons.history_rounded, color: const Color(0xFFF4A259), size: 20),
                const SizedBox(width: 10),
                const Text('전체 운동 기록 보기',
                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFFF4A259))),
                const Spacer(),
                Icon(Icons.chevron_right, color: const Color(0xFFF4A259).withOpacity(0.7), size: 20),
              ],
            ),
          ),
        ),
...
class _StepTab extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Text('${step.claimableCoins}개',
                          style: const TextStyle(
                              fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF42A5F5))),
                    ]),
                  ],
                ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('${currency.todayShoeCoin} / ${currency.dailyCap}개',
                            style: TextStyle(fontSize: 12, color: Colors.white.withOpacity(0.4))),
                      ],
                    ),
          ...
          if (step.error != null) ...[
            const SizedBox(height: 12),
            Text(step.error!, style: const TextStyle(fontSize: 12, color: Colors.redAccent)),
          ],
        ],
      ),
    );
  ...
  Future<void> _onClaim(BuildContext context, StepProvider step, CurrencyProvider currency) async {
          ...
          child: InkWell(
            ...
            child: ListTile(
              ...
              leading: Container(
                ...
                child: Image.asset('assets/images/ui/icon/home_holy_icon.png', width: 20, height: 20, fit: BoxFit.contain),
              ),
              title: Text(routine.name,
                  style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white)),
              subtitle: Text(
                  routine.exerciseCount != null ? '${routine.exerciseCount}개의 운동' : '',
  ...
  void _showDeleteDialog(BuildContext context) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('루틴 삭제', style: TextStyle(color: Colors.white)),
